...
namespace AI_3D_Models_Grasshopper
{
  public class AI_3D_Models_GrasshopperComponent : GH_Component
  {
    /// <summary>
    ...
    /// </summary>
    public AI_3D_Models_GrasshopperComponent()
      : base("AI_3D_Models_Grasshopper Component", "Nickname",
    ...
    /// </summary>
    public override Guid ComponentGuid => new Guid("f64917d8-d9e2-4a85-9986-235cec71546a");
  }
}